...
#if false
                        else if (body_format_ == BODY_FORMAT.BODY_70)
                        {
                            foreach (var limb in BODY_BONES_BODY_70)
                            {
                                Vector3 kp_1 = keypoints[getIdx(limb.Item1)];
                                Vector3 kp_2 = keypoints[getIdx(limb.Item2)];
...
#if false
        public static readonly Tuple<sl.BODY_70_PARTS, sl.BODY_70_PARTS>[] BODY_BONES_BODY_70 =
        {
